...
public class BikeFragment extends Fragment implements LocationCallback {
    ...
    private void parseLocationResult(JSONObject result) {
        ...
        try {
            ...
            if (result.getString(STATUS).equalsIgnoreCase(OK)) {
                ...
                Toast.makeText(getActivity().getBaseContext(), jsonArray.length() + " Supermarkets found!",
                        Toast.LENGTH_LONG).show();
            } else if (result.getString(STATUS).equalsIgnoreCase(ZERO_RESULTS)) {
                Toast.makeText(getActivity().getBaseContext(), "No Supermarket found in 10KM radius!!!",
                        Toast.LENGTH_LONG).show();
            }
