...
public class CarFragment extends Fragment implements LocationCallback {
...
//YOU Can change this type at your own will, e.g hospital, cafe, restaurant.... and see how it all works
        String type = "car_repair|car_wash|car_wash";
    ...
    private void parseLocationResult(JSONObject result) {
        ...
        try {
            ...
            if (result.getString(STATUS).equalsIgnoreCase(OK)) {
                ...
                Toast.makeText(getActivity().getBaseContext(), jsonArray.length() + " Car Service Stations found!",
                        Toast.LENGTH_LONG).show();
            } else if (result.getString(STATUS).equalsIgnoreCase(ZERO_RESULTS)) {
                Toast.makeText(getActivity().getBaseContext(), "No Car Service Stations found in 10KM radius!!!",
                        Toast.LENGTH_LONG).show();
            }
